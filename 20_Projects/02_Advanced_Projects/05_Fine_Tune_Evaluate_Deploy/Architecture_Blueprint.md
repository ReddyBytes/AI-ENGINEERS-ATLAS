...
**Derived metrics:**
- `p95_latency` — 95th percentile latency (SLA target: < 2000ms)
...
```
05_Fine_Tune_Evaluate_Deploy/
├── train.py                      # Training pipeline (from Starter_Code.md)
├── serve.py                      # FastAPI server (from Starter_Code.md)
